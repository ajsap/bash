#!/bin/bash
#######################
# disk_digest_daily.sh v1.0 (2016-06-21)
# Andy Saputra <yacsap@gmail.com>
# this script generates a daily report for production hard drives that had alerts in the last month and send it to specific zabbix users via email
# schedule it on cron (every working day at 09:00)
#######################
